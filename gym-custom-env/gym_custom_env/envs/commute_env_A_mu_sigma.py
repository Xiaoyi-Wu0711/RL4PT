...
class SubProcess_CommuteEnv_A_mu_sigma(CommuteEnvBase):
    ...
    def _apply_action(self, action):
        # Apply action to modify toll_A, toll_mu, and toll_sigma
        ...
        self.toll_sigma = np.clip(self.toll_sigma + self.action_weights[2] * action[2], 50, 70)
