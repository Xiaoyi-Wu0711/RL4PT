...
class CommuteEnv_one_dim_action(gym.Env): # env reset for each training/testing
    ...
    def step(self, action):
        ...
        tollparameters = np.array([120*self.toll_mu+420, 10*0.7621388+60, 2.95469884])
        ...
        if self.day == self.simulation_day_num-1:
            ...
            # print(" self.episode-2", self.episode)
            # print(" ")
